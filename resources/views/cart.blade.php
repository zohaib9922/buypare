    ...
    <div class="col-lg-8">
      ...
      <div class="mb-3">
        <div class="pt-4 wish-list">
          ...
          <h2 class="mb-4 name">Cart (<span>2</span> items)</h2>
            ...
            <div class="col-md-7 col-lg-9 col-xl-9">
              <div>
                <div class="d-flex justify-content-between">
                  <div>
                    <h3 style="margin-bottom: 10px">Blue denim shirt</h3>
          ...
          <hr class="mb-4">
          <div class="row mb-4 " style="padding-bottom: 29px;">
            <div class="col-md-5 col-lg-3 col-xl-3">
              <div class="view zoom overlay z-depth-1 rounded mb-3 mb-md-0">
                <img class="img-fluid w-100"
            ...
            <div class="col-md-7 col-lg-9 col-xl-9">
              <div>
                <div class="d-flex justify-content-between">
                  <div>
                    <h3 style="margin-bottom: 10px">Red hoodie</h3>
    ...
    <div class="col-lg-4">
      ...
      <div class="mb-3">
        <div class="pt-4">
          ...
          padding: 15px 0;
          font-size: 13px;
      " class="btn btn-primary btn-block">go to checkout</button>
