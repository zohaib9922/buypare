            ...
            <div class="products-row">
                <div class="col-md-3 product-grids"> 
                    <div class="agile-products">
                        ...
                        <a href="/product-detail"><img src="images/e1.png" class="img-responsive" alt="img"></a>
                        <div class="agile-product-text">              
                            <h5><a href="/product-detail">Audio speaker</a></h5> 
                            ...
                            <form action="#" method="">
                                ...
                                <button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Compare Product</button>
                            </form> 
                        </div>
                    </div> 
                </div>
                <div class="col-md-3 product-grids">
                    <div class="agile-products">
                        ...
                        <a href="/product-detail"><img src="images/e2.png" class="img-responsive" alt="img"></a>
                        <div class="agile-product-text">              
                            <h5><a href="/product-detail">Refrigerator</a></h5> 
                ...
                <div class="col-md-3 product-grids"> 
                    <div class="agile-products">
                        ...
                        <a href="/product-detail"><img src="images/e3.png" class="img-responsive" alt="img"></a>
                        <div class="agile-product-text">              
                            <h5><a href="/product-detail">Smart Phone</a></h5> 
                ...
                <div class="col-md-3 product-grids">
                    <div class="agile-products">
                        <div class="new-tag"><h6>New</h6></div>
                        <a href="/product-detail"><img src="images/e4.png" class="img-responsive" alt="img"></a>
                        <div class="agile-product-text">              
                            <h5><a href="/product-detail">Digital Camera</a></h5> 
